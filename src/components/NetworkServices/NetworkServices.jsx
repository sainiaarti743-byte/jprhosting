...
const NetworkServices = () => {
  ...
  return (
    ...
    <SEO 
        title="Enterprise Data Network Connectivity & Architecture"
        description="Connect distributed enterprise operations pipelines safely using high-grade multi-protocol label switching network arrays."
        keywords="enterprise networking solutions data connectivity pipelines MPLS"
        url="https://jprhosting.in/network-services/"
      />
    <NetworkSlider/>
        ...
        <div className="container">
          <div className="row align-items-center">
            ...
            <div className="col-md-6 text-center">
              ...
              <img src="/assets/img3/Network.svg" alt="Network Transformation Graphic" className="img-fluid" />
            </div>
          </div>
        </div>
      </section>
